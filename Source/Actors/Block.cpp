...
Block::Block(Game *game, const std::string &texturePath, ColliderLayer layer, bool hasCollision)
    : Actor(game)
{
    new DrawSpriteComponent(this, texturePath, Game::TILE_SIZE, Game::TILE_SIZE,0);
...
// {
//     new DrawSpriteComponent(this, texturePath, Game::TILE_SIZE, Game::TILE_SIZE, 0);
//     mColliderComponent = new AABBColliderComponent(this, 0, 0, Game::TILE_SIZE, Game::TILE_SIZE, ColliderLayer::Bricks, isStatic);
